...
<div class="navbar">
    <div class="navbar-inner">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="/haken14/admin/products">Productos</a> <span class="divider">/</span>
            </li>
...
<div class="block">
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Editar Producto</div>
    </div>
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <?php echo $this->Form->input("application_id",array('class'=>'control-group', 'label'=>'Aplicación')); ?>
                            ...
                            <div class="control-group">
                                ...
                                <img id="blah1" src="/haken14/admin/app/webroot/img/products/<?php echo $imagenes[0]['products']['img1']; ?>" alt="preview" class="img-rounded" style="margin: 10px; max-width: 50px; max-height: 50px; border: 2px solid #BADDFF; display: block;"/>
                            ...
                            <div class="control-group">
                                ...
                                <img id="blah2" src="/haken14/admin/app/webroot/img/products/<?php echo $imagenes[0]['products']['img2']; ?>" alt="preview" class="img-rounded" style="margin: 10px; max-width: 50px; max-height: 50px; border: 2px solid #BADDFF; display: block;"/>
                                <div class="uploader" id="uniform-fileInput">
                            ...
                            <div class="control-group">
                                ...
                                <img id="blah3" src="/haken14/admin/app/webroot/img/products/<?php echo $imagenes[0]['products']['img3']; ?>" alt="preview" class="img-rounded" style="margin: 10px; max-width: 50px; max-height: 50px; border: 2px solid #BADDFF; display: block;"/>
                                <div class="uploader" id="uniform-fileInput">

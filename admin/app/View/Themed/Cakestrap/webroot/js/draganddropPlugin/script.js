$(document).ready(function() {
			...
			reader.onload = function(e) {	
				...
				.load(function() {
					...
					createPreview(file, newimageurl);
                       // $('#upload').val(file);
                        //$('#upload').val(file);
                        //var formData = document.getElementById('addProduct');
	...
	****************************/
	var uploadToServer = function(oldFile, newFile) {
        ...
        //$('input[name=file]').val(oldFile);
        //$('input[name=file[]]').val(oldFile);

        //$('input[name=file]').val(oldFile);
        //var formData = document.getElementById('addProduct');
        //var formData = new FormData(document.forms.namedItem("addP"));
        ...
        /*var Miform = document.getElementById("addProduct");
        var formData = new FormData(Miform);
        formData.append('file[1]', oldFile);*/
